#!/usr/bin/env python3
"""
Figure 16: System Architecture - Optimized Spacing and Text Anchoring
Reduced whitespace, proper text alignment in all boxes
"""
...
# ============================================================================
# SECTION 3: METRICS & SPECIFICATIONS (Two columns) - PROPER TEXT ANCHORING
# ============================================================================
y_metrics = 5.2

# Left column: Production Configuration
metrics_box_left = FancyBboxPatch((0.5, y_metrics - 1.7), 7.3, 1.7, boxstyle="round,pad=0.1",
                                  edgecolor=color_border, facecolor=color_metrics, linewidth=2)
ax.add_patch(metrics_box_left)
ax.text(4.15, y_metrics + 0.45, 'Production Configuration: Normalizer + v3', 
...
metrics_box_right = FancyBboxPatch((8.2, y_metrics - 1.7), 7.3, 1.7, boxstyle="round,pad=0.1",
                                   edgecolor=color_border, facecolor=color_metrics, linewidth=2)
ax.add_patch(metrics_box_right)
ax.text(11.85, y_metrics + 0.45, 'Component Specifications', fontsize=9, fontweight='bold', 
...
# ============================================================================
# SECTION 4: KEY DESIGN PRINCIPLES (Bottom) - PROPER TEXT ANCHORING
# ============================================================================
y_principles = 2.8

principles_box = FancyBboxPatch((0.5, y_principles - 1.4), 15.0, 1.4, boxstyle="round,pad=0.1",
                                edgecolor='#0D47A1', facecolor='#E3F2FD', linewidth=2.5)
ax.add_patch(principles_box)
ax.text(8, y_principles + 0.65, 'Key Design Principles', fontsize=10, fontweight='bold', 
        color='#0D47A1', ha='center')
...
print("✓ Figure 16 (Optimized Spacing & Text Anchoring) generated successfully!")
print(f"  Saved to: {output_path}")
print("\nOptimization Improvements:")
print("  ✓ Reduced whitespace between pipeline and example box")
print("  ✓ Example box moved closer to title")
print("  ✓ Tighter overall vertical spacing")
print("  ✓ Text properly anchored in metrics boxes (left-aligned)")
print("  ✓ Text properly anchored in principles box (left-aligned)")
